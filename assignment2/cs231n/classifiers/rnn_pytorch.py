...
class CaptioningRNN:
    ...
    def loss(self, features, captions):
        ...
        word_in = word_embedding_forward(captions_in, W_embed)
        h = rnn_forward(word_in, h0, Wx, Wh, b) # [N, T, H]
        scores = torch.matmul(h, W_vocab)+b_vocab #NOTE mm is only for 2D tensor but h is 3D.
